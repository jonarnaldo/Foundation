...
const icon = (path: React.ReactNode, viewBox = '0 0 24 24') =>
  function Icon({ className = 'w-5 h-5', ...props }: IconProps) {
    return (
      <svg
...
export const ChevronUpIcon = icon(<path d="M18 15l-6-6-6 6" />)
...
export const BarChart2Icon = icon(<><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></>)
...
export const GripVerticalIcon = icon(<><circle cx="9" cy="5" r="1" fill="currentColor" stroke="none" /><circle cx="9" cy="9" r="1" fill="currentColor" stroke="none" /><circle cx="9" cy="13" r="1" fill="currentColor" stroke="none" /><circle cx="15" cy="5" r="1" fill="currentColor" stroke="none" /><circle cx="15" cy="9" r="1" fill="currentColor" stroke="none" /><circle cx="15" cy="13" r="1" fill="currentColor" stroke="none" /></>)
...
export const TrashIcon = icon(<><polyline points="3 6 5 6 21 6" /><path d="M19 6l-1 14H6L5 6" /><path d="M10 11v6M14 11v6" /><path d="M9 6V4h6v2" /></>)
